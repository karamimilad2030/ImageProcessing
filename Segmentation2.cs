...
namespace Denas
{
    public partial class frmSegmentation2 : Form
    {
        public frmSegmentation2()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                ma.nobel(openFileDialog1.FileName);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.OK)
            {
                ma.dgaus(openFileDialog1.FileName);
        ...
        {
            frmFracture2 r = new frmFracture2();
            r.Show();
            this.Hide();
        }
    }
